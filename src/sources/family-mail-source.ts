...
import { FAMILY_GMAIL_QUERIES, summarizeMessage } from './query-presets.js'

export async function collectFamilyMailSignals() {
  ...
  for (const query of FAMILY_GMAIL_QUERIES) {
  ...
  return {
    ...
    queryCount: FAMILY_GMAIL_QUERIES.length,
  }
}
